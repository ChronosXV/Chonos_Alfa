...
namespace MenuInicio.DATASET {
    ...
    public partial class ChronosDataSet11 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/ChronosDataSet111.xsd";
        ...
        public partial class paisDataTable : global::System.Data.TypedTableBase<paisRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public paisRow AddpaisRow(string descripcion) {
...
namespace MenuInicio.DATASET.ChronosDataSet11TableAdapters {
    ...
    public partial class paisTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[pais] WHERE (([idPais] = @Original_idPais) AND ((@IsNull_descr" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[pais] ([descripcion]) VALUES (@descripcion);\r\nSELECT idPais, d" +
                "escripcion FROM pais WHERE (idPais = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[pais] SET [descripcion] = @descripcion WHERE (([idPais] = @Original" +
                "_idPais) AND ((@IsNull_descripcion = 1 AND [descripcion] IS NULL) OR ([descripci" +
                "on] = @Original_descripcion)));\r\nSELECT idPais, descripcion FROM pais WHERE (idP" +
                "ais = @idPais)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idPais, descripcion FROM dbo.pais";
        ...
        public virtual int Fill(ChronosDataSet11.paisDataTable dataTable) {
        ...
        public virtual ChronosDataSet11.paisDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ChronosDataSet11.paisDataTable dataTable = new ChronosDataSet11.paisDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ChronosDataSet11.paisDataTable dataTable) {
        ...
        public virtual int Update(string descripcion, int Original_idPais, string Original_descripcion, int idPais) {
            if ((descripcion == null)) {
        ...
        public virtual int Update(string descripcion, int Original_idPais, string Original_descripcion) {
            return this.Update(descripcion, Original_idPais, Original_descripcion, Original_idPais);
        }
    }
